            ...
            if ($request->type == 1) {
                ...
                if ($request->url == $base_url) {
                    if (helper::appdata($request->vendor_id)->template == 1) {
                        ...
                        $data = '<a class="theme-2-product-icon text-secondary"  href="javascript:void(0)" onclick="managefavorite(' . $request->vendor_id . ',' . $request->slug . ',0,' . chr(0x27) . $request->favurl . chr(0x27) . ',' . chr(0x27) . $request->url . chr(0x27) . ')" title="' . trans('labels.remove_wishlist') . '"> <i class="fa-solid fa-heart"></i> </a>';
            ...
            if ($request->type == 0) {
                ...
                if ($request->url == $base_url) {
                    if (helper::appdata($request->vendor_id)->template == 1) {
                        ...
                        $data = '<a class="theme-2-product-icon text-secondary" href="javascript:void(0)" onclick="managefavorite(' . $request->vendor_id . ',' . $request->slug . ',1,' . chr(0x27) . $request->favurl . chr(0x27) . ',' . chr(0x27) . $request->url . chr(0x27) . ')" title="' . trans('labels.add_wishlist') . '"><i class="fa-regular fa-heart"></i> </a>';
                    } else if (helper::appdata($request->vendor_id)->template == 3) {
                        $data = '<a href="javascript:void(0)"  onclick="managefavorite(' . $request->vendor_id . ',' . $request->slug . ',1,' . chr(0x27) . $request->favurl . chr(0x27) . ',' . chr(0x27) . $request->url . chr(0x27) . ')" title="' . trans('labels.add_wishlist') . '"><i class="fa-regular fa-heart"></i> </a>';
                    } else {
                        $data = '<a href="javascript:void(0)"  onclick="managefavorite(' . $request->vendor_id . ',' . $request->slug . ',1,' . chr(0x27) . $request->favurl . chr(0x27) . ',' . chr(0x27) . $request->url . chr(0x27) . ')" title="' . trans('labels.add_wishlist') . '"><i class="fa-regular fa-heart"></i> </a>';
