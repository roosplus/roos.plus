...
$("#addfeature").click(function() {
    ...
    var html =
        ...
        '<div class="d-flex gap-2 mb-3" id="removediv-' + i +

        '"><input type="text" class="form-control" name="plan_features[]" value="" placeholder="" required><button type="button" class="btn btn-danger hov btn-sm rounded-5" onclick="removefeature(' +
