                                    ...
                                    <div class="card-body pt-4">
                                        ...
                                        <div class="d-flex align-items-center py-3">
                                            <p class="fs-7 text-center fw-500 text-muted">
                                                <?php echo e(trans('labels.already_have_an_account')); ?></p>
                                            <a href="<?php echo e(URL::to('/admin')); ?>"
                                                class="text-primary fw-semibold px-1"><?php echo e(trans('labels.login')); ?></a>
                                        </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <?php if(session()->has('social_login')): ?>
                                                        <input type="text" class="form-control extra-padding"
                                                            name="name"
                                                            value="<?php echo e(session()->get('social_login')['name']); ?>"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <?php if(session()->has('social_login')): ?>
                                                        <input type="email" class="form-control extra-padding"
                                                            name="email"
                                                            value="<?php echo e(session()->get('social_login')['email']); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="mobile"
                                                        class="form-label"><?php echo e(trans('labels.mobile')); ?><span
                                                            class="text-danger"> * </span></label>
                                                ...
                                                <?php if(App\Models\SystemAddons::where('unique_identifier', 'unique_slug')->first() != null &&
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <span
                                                                class="input-group-text col-5 col-md-auto overflow-scroll extra-padding fs-8"><?php echo e(URL::to('/')); ?>/</span>
                                                ...
                                                <div class="form-group my-3">
                                                    ...
                                                    <label class="form-check-label" for="check_terms">
                                                        <?php echo e(trans('labels.i_accept_the')); ?> <span class="fw-600"><a
                                                                href="<?php echo e(URL::to('/terms_condition')); ?>"
...
<?php echo $__env->make('admin.layout.auth_default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/auth/register.blade.php ENDPATH**/ ?>