                ...
                <form action="<?php echo e(URL::to('admin/settings/updategoogle')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div
                        ...
                        <input id="checkbox-switch-google" type="checkbox" class="checkbox-switch" name="google_login"
                            value="1" <?php echo e($settingdata->google_login == 1 ? 'checked' : ''); ?>>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group">
                                <label class="form-label"><?php echo e(trans('labels.google_client_id')); ?><span
                                        class="text-danger"> * </span></label>
                                <input type="text" class="form-control" name="google_client_id"
                                    value="<?php echo e(@$settingdata->google_client_id); ?>"
                                    placeholder="<?php echo e(trans('labels.google_client_id')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <label class="form-label"><?php echo e(trans('labels.google_client_secret')); ?><span
                                        class="text-danger"> * </span></label>
                                <input type="text" class="form-control" name="google_client_secret"
                                    value="<?php echo e(@$settingdata->google_client_secret); ?>"
                                    placeholder="<?php echo e(trans('labels.google_client_secret')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                <label class="form-label"><?php echo e(trans('labels.google_redirect_url')); ?><span
                                        class="text-danger"> * </span></label>
                                <input type="text" class="form-control" name="google_redirect_url"
                                    value="<?php echo e(@$settingdata->google_redirect_url); ?>"
                                    placeholder="<?php echo e(trans('labels.google_redirect_url')); ?>" required>
...
<?php /**PATH /mnt/c/restro-saas/resources/views/admin/sociallogin/google_login.blade.php ENDPATH**/ ?>