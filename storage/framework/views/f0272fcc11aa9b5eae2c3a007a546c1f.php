    ...
    <div class="navbar-header">
        ...
        <div class="d-flex align-items-center">
            ...
            <?php if(Auth::user()->type == 2): ?>
                <a class="header_icon_box mx-2 bg-warning" href="<?php echo e(URL::to('/' . Auth::user()->slug)); ?>"
                    target="_blank">
            ...
            <?php if(App\Models\SystemAddons::where('unique_identifier', 'language')->first() != null &&
                ...
                <div class="position-relative mx-1">
                    <div class="dropdown">
                        ...
                        <ul
                            class="dropdown-menu drop-menu shadow border-0 <?php echo e(session()->get('direction') == 2 ? 'drop-menu-rtl' : 'drop-menu'); ?>">
            ...
            <div class="dropwdown d-inline-block">
                ...
                <div class="dropdown-menu shadow border-0">
                    <a href="<?php echo e(URL::to('admin/settings')); ?>#settings"
...
<?php /**PATH /mnt/c/restro-saas/resources/views/admin/layout/header.blade.php ENDPATH**/ ?>