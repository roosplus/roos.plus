...
<header class="main-header">
    <div class="navbar d-flex align-items-center">
        <div class="container">
            ...
            <nav class="main-menu navbar navbar-expand-lg ms-xl-5 me-auto d-none d-xl-block">
            ...
            <div class="d-flex gap-3">
                ...
                <div class="d-flex justify-content-end d-none d-xl-block">
                    <a href="<?php echo e(URL::to('/admin')); ?>" class="btn btn-secondary px-3 py-2 rounded text-end" target="_blank"><span class="m-0  fs-15 fw-500"><?php echo e(trans('landing.get_started')); ?></a>
                </div>
                <button class="btn text-white border-white d-block d-xl-none m-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebar" aria-controls="offcanvasRight"><i class="fa-solid fa-bars-staggered"></i></button>
            </div>
...
<?php echo $__env->make('cookie-consent::index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/landing/layout/header.blade.php ENDPATH**/ ?>