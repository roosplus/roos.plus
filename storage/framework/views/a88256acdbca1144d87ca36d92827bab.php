                            ...
                            <div class="p-4">
                                <div class="card overflow-hidden border-0 w-100 bg-transparent">
                                    <div class="card-body pt-0">
                                        <h4 class="fw-bold text-dark fs-1 pb-0 mb-0"><?php echo e(trans('labels.forgot_password')); ?>

                                        </h4>
                                        <div class="d-flex align-items-center pt-3 pb-0">
                                            <p class="fs-7 text-center fw-500 text-muted">
                                                <?php echo e(trans('labels.remember_password')); ?></p>
                                            <a href="<?php echo e(URL::to('/admin')); ?>"
                                                class="text-primary fw-semibold px-2"><?php echo e(trans('labels.login')); ?></a>
                                        </div>
...
<?php echo $__env->make('admin.layout.auth_default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/auth/forgotpassword.blade.php ENDPATH**/ ?>