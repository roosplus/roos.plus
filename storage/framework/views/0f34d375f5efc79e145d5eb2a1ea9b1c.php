...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-between align-items-center mb-3">
        <div class="col-12 col-md-4">
            <h5 class="pages-title fs-2"><?php echo e(trans('labels.store_categories')); ?></h5>
            <div class="d-flex">
        ...
        <div class="col-12 col-md-8">
            <div class="d-flex justify-content-end">
                <a href="<?php echo e(URL::to('admin/store_categories/add')); ?>"
                                ...
                                <tr class="fs-7 align-middle row1" id="dataid<?php echo e($category->id); ?>"
                                    ...
                                    <td>
                                        ...
                                        <?php if($category->is_available == '1'): ?>
                                            <a tooltip="<?php echo e(trans('labels.active')); ?>"
                                                <?php if(env('Environment') == 'sendbox'): ?> onclick="myFunction()" <?php else: ?> onclick="statusupdate('<?php echo e(URL::to('admin/store_categories/change_status-' . $category->id . '/2')); ?>')" <?php endif; ?>
                                                class="btn btn-sm btn-success btn-size"><i class="fas fa-check"></i></a>
                                        <?php else: ?>
                                            <a tooltip="<?php echo e(trans('labels.inactive')); ?>"
                                                <?php if(env('Environment') == 'sendbox'): ?> onclick="myFunction()" <?php else: ?> onclick="statusupdate('<?php echo e(URL::to('admin/store_categories/change_status-' . $category->id . '/1')); ?>')" <?php endif; ?>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="<?php echo e(URL::to('admin/store_categories/edit-' . $category->id)); ?>"
                                                tooltip="<?php echo e(trans('labels.edit')); ?>" class="btn btn-info btn-sm btn-size">
                                                <i class="fa-regular fa-pen-to-square"></i></a>

                                            <a tooltip="<?php echo e(trans('labels.delete')); ?>"
                                                <?php if(env('Environment') == 'sendbox'): ?> onclick="myFunction()" <?php else: ?> onclick="statusupdate('<?php echo e(URL::to('admin/store_categories/delete-' . $category->id)); ?>')" <?php endif; ?>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/store_categories/index.blade.php ENDPATH**/ ?>