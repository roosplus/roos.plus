    ...
    <div class="col-12 mt-3 mb-7">
        ...
        <div class="card border-0 box-shadow">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(URL::to('/admin/promotionalbanners/update-' . $banner->id)); ?>" method="POST"
                            ...
                            <select class="form-select" name="vendor" id="" required>
                                ...
                                <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($vendor->id); ?>"
                                        <?php echo e($vendor->id == $banner->vendor_id ? 'selected' : ''); ?>><?php echo e($vendor->name); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <img src="<?php echo e(helper::image_path($banner->image)); ?>" class="hight-50 mt-2 rounded-3 object-fit-cover"
                                alt="">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/promotionalbanners/edit.blade.php ENDPATH**/ ?>