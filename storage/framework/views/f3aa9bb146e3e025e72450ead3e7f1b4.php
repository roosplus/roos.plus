                                        ...
                                        <form method="POST" class="mb-5"
                                            ...
                                            <div class="form-group mb-3">
                                                <input id="username" type="text"
                                                    class="form-control extra-padding <?php $__errorArgs = ['username'];
...
unset($__errorArgs, $__bag); ?>
                                            <div class="form-group mb-3">
                                                <input id="purchase_key" type="text"
                                                    class="form-control extra-padding <?php $__errorArgs = ['purchase_key'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="form-group mb-3">
                                                <input id="domain" type="hidden"
                                                    class="form-control extra-padding <?php $__errorArgs = ['domain'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                    ...
                                                    value="<?php echo e($text); ?>" readonly="">
                                            </div>
...
<?php echo $__env->make('admin.layout.auth_default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/auth/verify.blade.php ENDPATH**/ ?>