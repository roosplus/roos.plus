                    ...
                    <div class="row border-bottom pb-4 pb-lg-0">
                        <div class="col-12 col-md-8 col-xl-6 mb-lg-4 md-1">
                            <label class="form-label">
                                ...
                                <div class="d-flex">
                                    <input type="text" class="form-control w-50 time-interval <?php echo e(session()->get('direction') == 2 ? 'rounded-start-0 rounded-end-5' : 'rounded-end-0 rounded-start-5'); ?>" name="interval_time"
                                    ...
                                    <select name="interval_type" class="form-select w-25 working-hoursselect <?php echo e(session()->get('direction') == 2 ? 'rounded-start-5 rounded-end-0' : 'rounded-end-5 rounded-start-0'); ?>" id="">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row pt-2 pt-md-3">
                        <label class="col-md-2 text-satrt mb-3 d-none d-lg-block d-xl-block d-xxl-block fw-500 fs-6">Day</label>
                        <label
                            class="col-md-2 text-satrt mb-3 d-none d-lg-block d-xl-block d-xxl-block fw-500 fs-6"><?php echo e(trans('labels.opening_time')); ?></label>
                        <label
                            class="col-md-2 text-satrt mb-3 d-none d-lg-block d-xl-block d-xxl-block fw-500 fs-6"><?php echo e(trans('labels.break_start')); ?></label>
                        <label
                            class="col-md-2 text-satrt mb-3 d-none d-lg-block d-xl-block d-xxl-block fw-500 fs-6"><?php echo e(trans('labels.break_end')); ?></label>
                        <label
                            class="col-md-2 text-satrt mb-3 d-none d-lg-block d-xl-block d-xxl-block fw-500 fs-6"><?php echo e(trans('labels.closing_time')); ?></label>
                        <label
                            class="col-md-2 text-satrt mb-3 d-none d-lg-block d-xl-block d-xxl-block fw-500 fs-6"><?php echo e(trans('labels.always_closed')); ?></label>
                    </div>
                    <?php $__currentLoopData = $gettime; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row my-2">
                            <div class="form-group col-md-2">
                                <label class="form-label text-center fw-500 fs-15">
                    ...
                    <div class="form-group m-0 mt-2 d-flex gap-2 justify-content-end">
                        <button
                            ...
                            class="btn btn-secondary px-4 rounded-start-5 rounded-end-5 <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_working_hours', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>"><?php echo e(trans('labels.save')); ?></button>
                    </div>
                </form>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/otherpages/time.blade.php ENDPATH**/ ?>