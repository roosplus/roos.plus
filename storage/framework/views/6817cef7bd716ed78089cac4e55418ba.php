                ...
                <form action="<?php echo e(URL::to('admin/extras/save')); ?>" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group m-0 mt-2 d-flex gap-2 justify-content-end">
                            ...
                            <button
                                class="btn btn-secondary px-4 rounded-start-5 rounded-end-5   <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_global_extras', Auth::user()->role_id, Auth::user()->vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>"
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/extras/add.blade.php ENDPATH**/ ?>