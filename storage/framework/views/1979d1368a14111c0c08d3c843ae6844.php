...
<body>
    <div class="head-title">
        <h1 class="text-center m-0 p-0"><?php echo e(trans('labels.category_list')); ?></h1>
    </div>
...
<?php /**PATH /mnt/c/restro-saas/resources/views/admin/product/categorylist.blade.php ENDPATH**/ ?>