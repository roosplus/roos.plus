                                ...
                                <tr class="fs-7 align-middle">
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a <?php if(env('Environment') == 'sendbox'): ?> onclick="myFunction()" <?php else: ?> onclick="deletedata('<?php echo e(URL::to('admin/subscribers/delete-' . $subscriber->id)); ?>')" <?php endif; ?>
                                                class="btn btn-danger btn-sm  btn-size <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_subscribers', Auth::user()->role_id, $vendor_id, 'delete') == 1 ? '' : 'd-none') : ''); ?>">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/subscriber/index.blade.php ENDPATH**/ ?>