...
<?php $__env->startSection('content'); ?>
    <div class="row justify-content-between align-items-center">
        <div class="col-12 col-md-4">
            <h5 class="pages-title fs-2"><?php echo e(trans('labels.who_we_are')); ?></h5>
            ...
            <div class="card border-0 mb-3 box-shadow">
                ...
                <div class="text-end">
                    ...
                    <a href="<?php echo e(URL::to(request()->url() . '/add')); ?>"
                        class="btn btn-secondary px-4 mx-3 mt-3 rounded-start-5 rounded-end-5 <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_who_we_are', Auth::user()->role_id, $vendor_id, 'add') == 1 ? '' : 'd-none') : ''); ?>">
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="<?php echo e(URL::to('/admin/whoweare/edit-' . $content->id)); ?>"
                                                    class="btn btn-info btn-size btn-sm <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_who_we_are', Auth::user()->role_id, $vendor_id, 'edit') == 1 ? '' : 'd-none') : ''); ?>">
                                                ...
                                                <a href="javascript:void(0)"
                                                    ...
                                                    class="btn btn-danger btn-size btn-sm <?php echo e(Auth::user()->type == 4 ? (helper::check_access('role_who_we_are', Auth::user()->role_id, $vendor_id, 'delete') == 1 ? '' : 'd-none') : ''); ?>">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/who_we_are/index.blade.php ENDPATH**/ ?>