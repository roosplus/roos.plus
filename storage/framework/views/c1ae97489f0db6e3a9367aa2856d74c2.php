            ...
            <div class="col-12">
                <div class="d-flex gap-2 align-items-center">
                    <h3 class="page-title mb-0">
                        <?php echo e(trans('labels.have_question')); ?>
                ...
                <div class="d-flex flex-wrap gap-2 mt-2 align-items-center justify-content-between">
                    <div class="col-xl-10 col-md-9">
                        <p class="m-0 fs-7 text-muted line-2">
                            <?php echo e(trans('labels.have_question_note')); ?>

                        </p>
                    </div>
                    <div class="col-sm-auto col-12">
                        <a href="<?php echo e(URL::to(@$storeinfo->slug . '/contact')); ?>"
...
</section><?php /**PATH /mnt/c/restro-saas/resources/views/front/sum_qusction.blade.php ENDPATH**/ ?>