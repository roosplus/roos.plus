...
<form method="POST" action="<?php echo e(URL::to('admin/products/get-product-variants-possibilities')); ?>">
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="variant_name" type="text" id="variant_name" placeholder="<?php echo e(__('Variant Name, i.e Size, Color etc')); ?>" onkeyup="this.value = this.value.replace(/[`\/\\|~_$&+,:;=?[\]@#{}'<>.^*()%!-/]/, '')">
    </div>
    <div class="form-group">
...
<?php /**PATH /mnt/c/restro-saas/resources/views/admin/product/variants/create.blade.php ENDPATH**/ ?>