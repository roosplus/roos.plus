    ...
    <div class="col-12 mb-7">
        <div class="card border-0 box-shadow">
            ...
            <div class="card-body">
                ...
                <form action="<?php echo e(URL::to('admin/store_categories/save')); ?>" method="POST">
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/store_categories/add.blade.php ENDPATH**/ ?>