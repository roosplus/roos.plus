    ...
    <div class="row">
        <div class="col-12">
            <div class="card border-0 box-shadow">
                <div class="card-body">
                    <form action="<?php echo e(URL::to('/admin/how_works/save')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="subtitle" value="<?php echo e(old('subtitle')); ?>"
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/how_work/add.blade.php ENDPATH**/ ?>