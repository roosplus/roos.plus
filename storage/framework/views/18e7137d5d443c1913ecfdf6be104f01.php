        ...
        <div class="col-12">
            ...
            <div class="card border-0 box-shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="<?php echo e(URL::to('admin/coupons/update-' . $promocode->id)); ?>" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control" name="offer_name"
                                    value="<?php echo e($promocode->offer_name); ?>" placeholder="<?php echo e(trans('labels.offer_name')); ?>"
                                    required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <label class="form-label"><?php echo e(trans('labels.offer_code')); ?><span
                                        class="text-danger">*</span></label>

                                <input type="text" class="form-control" name="offer_code"
                                    value="<?php echo e($promocode->offer_code); ?>" placeholder="<?php echo e(trans('labels.offer_code')); ?>"
                                    required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" name="offer_type" required>
                                            ...
                                            <option value="1" <?php echo e($promocode->offer_type == '1' ? 'selected' : ''); ?>>
                                                <?php echo e(trans('labels.fixed')); ?></option>

                                            <option value="2" <?php echo e($promocode->offer_type == '2' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control numbers_only" name="amount"
                                            value="<?php echo e($promocode->offer_amount); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" class="form-control numbers_only" name="order_amount"
                                    value="<?php echo e($promocode->min_amount); ?>"
                                    <?php if(Auth::user()->type == 1): ?> placeholder="<?php echo e(trans('labels.min_plan_amount')); ?>" 
                                    <?php else: ?>
                                    placeholder="<?php echo e(trans('labels.min_order_amount')); ?>" <?php endif; ?>
                                    required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="start_date"
                                                value="<?php echo e($promocode->start_date); ?>" id="start_date"
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control" name="end_date"
                                                value="<?php echo e($promocode->exp_date); ?>" id="end_date"
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class=" form-group">
                                    ...
                                    <select class="form-select type" name="usage_type">
                                        ...
                                        <option value="1" <?php echo e($promocode->usage_type == '1' ? 'selected' : ''); ?>>
                                            <?php echo e(trans('labels.limited_time')); ?></option>

                                        <option value="2" <?php echo e($promocode->usage_type == '2' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group" id="usage_limit_input">
                                    ...
                                    <input type="text" class="form-control" name="usage_limit"
                                        value="<?php echo e($promocode->usage_limit); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <textarea name="description" class="form-control" rows="4" placeholder="<?php echo e(trans('labels.description')); ?>"
                                    required><?php echo e($promocode->description); ?></textarea>
...
<?php echo $__env->make('admin.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/admin/included/promocode/edit.blade.php ENDPATH**/ ?>