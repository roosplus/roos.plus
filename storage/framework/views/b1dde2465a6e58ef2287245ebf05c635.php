    ...
    <section id="our-stores ">
        ...
        <?php if(count($stores) > 0): ?>
            <div class="container">
                ...
                <div
                    class="row row-cols-1 mt-2 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 row-cols-xl-4 row-cols-xll-4 g-2 py-5">
                            ...
                            <a href="<?php echo e(URL::to($store->slug . '/')); ?>" target="_blank">
                                ...
                                <div class="card mx-1 rounded-4 h-100 border-0">
                                    ...
                                    <div class="card-body px-0">
                                        ...
                                        <h5 class="card-title hotel-title"><?php echo e(@helper::appdata($store->id)->website_title); ?>
...
<?php echo $__env->make('landing.layout.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/restro-saas/resources/views/landing/store_list.blade.php ENDPATH**/ ?>