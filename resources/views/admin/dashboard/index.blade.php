    ...
    @if (Auth::user()->type != 1)
        ...
        <div class="row">
            <div class="col-xl-6 mb-4">
                <div class="card border-0 box-shadow h-100">
                    <div class="card-body">
                        <h5 class="card-title pb-3 m-0">{{ trans('labels.top_product') }}</h5>
                                    ...
                                    @if (count($topitems) > 0)
                                        @foreach (@$topitems as $row)
                                            <tr class="fs-7 fw-500 text-dark align-middle">
                                                <td>
                                                    <img src="{{ Helper::image_path($row['item_image']->image) }}"
                                                        class="rounded hw-50 object" alt="">
                                                </td>
                                                <td>
                                                    <a
                                                        href="{{ URL::to('admin/products/edit-' . $row->slug) }}">{{ $row->item_name }}</a>
                                                </td>
            ...
            <div class="col-xl-6 mb-4">
                <div class="card border-0 box-shadow h-100">
                    <div class="card-body">
                        <h5 class="card-title pb-3 m-0">{{ trans('labels.top_customers') }}</h5>
