<header class="page-topbar">
    <div class="navbar-header">
        ...
        <div class="d-flex align-items-center">
            ...
            @endif
            @if (Auth::user()->type == 2)
                <a class="header_icon_box mx-2 bg-warning" href="{{ URL::to('/' . Auth::user()->slug) }}"
                    target="_blank">
            ...
            @if (App\Models\SystemAddons::where('unique_identifier', 'language')->first() != null &&
                ...
                <div class="position-relative mx-1">
                    <div class="dropdown">
                        ...
                        <ul
                            class="dropdown-menu drop-menu shadow border-0 {{ session()->get('direction') == 2 ? 'drop-menu-rtl' : 'drop-menu' }}">
            ...
            <div class="dropwdown d-inline-block">
                ...
                <div class="dropdown-menu shadow border-0">
                    <a href="{{ URL::to('admin/settings') }}#settings"
