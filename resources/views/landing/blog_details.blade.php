    ...
    <section id="blog" class="blog py-5">
        <div class="container">
            <div class="sec-title mb-5" data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                <h2 class="text-capitalize">{{ trans('landing.blog_details') }}</h2>
            ...
            <div class="sec-title my-5" data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
                <h2 class="text-capitalize">{{ trans('landing.related_blogs') }}</h2>
            ...
            <div class="d-flex justify-content-center align-items-center">
                <a href="{{ URL::to('blog_list') }}" class="btn btn-secondary fw-500 px-3">See all <i
