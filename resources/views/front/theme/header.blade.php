                ...
                <div class="d-flex align-items-center gap-3">
                    <nav class="align-items-center {{ session()->get('direction') == 2 ? 'menu-rtl' : 'menu' }}">
                        ...
                        <ul class="navbar-nav header-menu-items">
                            ...
                            <li class="nav-item dropdown header-dropdown-menu px-4">
                                <a href="{{ URL::to(@$storeinfo->slug . '/tablebook') }}"
                                    class="nav-link {{ request()->is(@$storeinfo->slug . '/tablebook') ? 'active' : '' }} {{ request()->is('tablebook') ? 'active' : '' }}">
                            ...
                            @if (App\Models\SystemAddons::where('unique_identifier', 'customer_login')->first() != null &&
                                ...
                                @if (Auth::user() && Auth::user()->type == 3)
                                    ...
                                    <a onclick="statusupdate('{{ URL::to($storeinfo->slug . '/logout/') }}')"
                                        class="login-button-mobile login-buuton d-lg-none cursor-pointer">{{ trans('labels.logout') }}</a>
                                @else
